...
{
    "Account": {
        "Summary": { "currentBalance": "2405000.50", "currency": "INR" },
        "Transactions": {
            "Transaction": [
                { "type": "CREDIT", "mode": "NEFT", "amount": "120000.0", "transactionTimestamp": "2023-08-01T10:00:00", "narration": "SALARY CREDIT - TECH CORP" },
                { "type": "DEBIT", "mode": "ACH", "amount": "15000.0", "transactionTimestamp": "2023-08-02T09:00:00", "narration": "SIP INVESTMENT - MUTUAL FUND" },
                { "type": "DEBIT", "mode": "UPI", "amount": "25000.0", "transactionTimestamp": "2023-08-05T11:00:00", "narration": "RENT PAYMENT AUGUST" },
                { "type": "DEBIT", "mode": "CARD", "amount": "4500.0", "transactionTimestamp": "2023-08-06T19:30:00", "narration": "ZARA SHOPPING" },
                { "type": "DEBIT", "mode": "UPI", "amount": "1200.0", "transactionTimestamp": "2023-08-08T20:15:00", "narration": "FINE DINE RESTAURANT" },
                { "type": "CREDIT", "mode": "ACH", "amount": "3500.0", "transactionTimestamp": "2023-08-10T10:00:00", "narration": "DIVIDEND PAYOUT" },
                { "type": "DEBIT", "mode": "UPI", "amount": "800.0", "transactionTimestamp": "2023-08-12T14:00:00", "narration": "NETFLIX SUBSCRIPTION" }
            ]
        }
    }
}
...
def main():
    ...
    # --- LOAD MCP TOOLS FOR INVESTMENT ---
    mcp_tools_list = get_investment_mcp_tools()

    # for tool in mcp_tools_list.functions:
    ...
    # We add mcp_tools_list here so this agent can talk to Yahoo Finance
